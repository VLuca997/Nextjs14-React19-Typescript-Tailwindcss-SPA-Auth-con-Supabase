...
const Pricing = () => {
  return (
    <div >
    <div className="bg-[#ffd148] flex items-center justify-center min-h-screen relative z-10" id='pricing'>
        ...
        <div
            ...
            <h1 className="font-semibold text-2xl mb-2 tracking-wider drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">Website -
                Sponsorship</h1>
            ...
            <ul className="flex items-start justify-between gap-8 mt-10 md:flex-row flex-col">
                ...
                <li
                    ...
                    <button className="w-full p-2 bg-transparent text-[#13181f] rounded-md font-semibold hover:bg-[#13181f] hover:text-white transition-all duration-150 ease-in mb-8 border border-[#13181f]">get on the waiting list</button>
                    <ol className="list-disc text-[#ff2865] w-[80%] mx-auto">
